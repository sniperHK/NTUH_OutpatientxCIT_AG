...
> **降階兵法對應**：暗語系統屬於 **[伐謀層級](/content/M07#zero)**（事前計畫預防升級），成本最低效果最好。一旦讓情境惡化到需要硬體警報，就已經走到**伐兵**了。
...
> **四大樣態連結**：被困情境下，病人多半呈現 **[LOC 失去控制感](/content/M02#section-2)**（易怒、衝動、踱步）。應對原則：**不要硬碰硬**。用 [M04 轉移焦點五招](/content/M04#section-6) 中的「從站到坐」、「從情緒到任務」把對方的注意力從你身上拉開。若伴隨 **LOR（幻聽／妄想）**，則額外注意不否定幻覺內容、避免突然動作。
...
- **← [M01 暴力曲線](/content/M01)**：眼耳鼻舌身意六感評估 — 環境掃描從感官偵測開始
- **← [M02 Agitation 急性處置](/content/M02)**：四大樣態 LOR/LOC/LOH/LOP 決定環境應對策略
- **→ [M04 言語降階](/content/M04)**：環境安全後，進入五步驟降階（戰術三寶：武力/距離/掩體）
- **→ [M07 現場應變](/content/M07)**：持械情境的環境撤離標準流程 + 降階兵法
