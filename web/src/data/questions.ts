...
export const questions: Question[] = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: '先自行規勸病人，通知 Leader 後再決定是否聯繫駐警', isCorrect: false },
      { id: 'B', text: '立即聯繫駐警隊，駐警主動聯絡轄區派出所', isCorrect: true },
      { id: 'C', text: '先通知護理長，由護理長決定是否報警', isCorrect: false },
      { id: 'D', text: '先拍照蒐證，再通知相關人員', isCorrect: false },
    ],
    explanation:
      '依 5/26「門診暴力事件應變作業流程」，肢體暴力屬升級情境：應立即啟動求助機制——電話通知駐警隊（同步啟動電腦暴力事件通報系統、按緊急壓扣、通知單位主管與門診部行政人員），駐警到場後主動聯絡轄區派出所到院。自行先規勸、由護理長決定才報警、或先拍照蒐證都會延誤求助時機。',
  },
  {
    id: 'Q04',
    type: 'single-choice',
  ...
  },
  {
    ...
    category: 'post',
    module: 'M06',
    stem: '病人持雨傘揮舞並大喊：「再不讓我看診我就砸了你們櫃檯！」此時正確的處置／通報方式是？',
    options: [
      { id: 'A', text: '先以停聽同選自行規勸，暫不通報', isCorrect: false },
      { id: 'B', text: '立即啟動求助機制：電話通知駐警隊，駐警到場後主動聯絡轄區派出所', isCorrect: true },
      { id: 'C', text: '第一時間直接撥打 110', isCorrect: false },
      { id: 'D', text: '先由 Leader 到場評估再決定', isCorrect: false },
    ],
    explanation:
      '持物揮舞屬於肢體暴力的前兆/行為，應立即啟動求助機制：電話通知駐警隊（同步啟動電腦通報系統、按緊急壓扣、通知主管與門診部行政），駐警到場後主動聯絡轄區派出所。直接撥 110 保留給持凶器、已造成人員受傷等立即危險情境（對應 SOP「必要時報警」）。',
  },
  {
    id: 'Q23',
    type: 'scenario',
  ...
  // === 決策樹與暴力曲線 ===
  {
    ...
    category: 'post',
    module: 'M06',
    stem: '候診病人突然抓起椅子高舉過頭，大喊「再不叫我看診就砸了！」此時正確的處置是？',
    scenarioContext: '下午門診候診區，病人已等候 2 小時',
    options: [
      { id: 'A', text: '先以停聽同選嘗試規勸，暫不啟動通報', isCorrect: false },
      { id: 'B', text: '立即啟動求助機制：電話通知駐警隊，駐警到場後主動聯絡轄區派出所', isCorrect: true },
      { id: 'C', text: '先通知護理長到場評估', isCorrect: false },
      { id: 'D', text: '自行上前奪取椅子', isCorrect: false },
    ],
    explanation:
      '持物品揮舞（抓椅子高舉）屬於肢體暴力行為，應立即啟動求助機制：電話通知駐警隊（同步啟動電腦通報系統、按緊急壓扣），駐警到場後主動聯絡轄區派出所。此時言語降階的風險過高，絕對不要嘗試自行奪取物品。',
  },
  {
    id: 'Q32',
    type: 'single-choice',
  ...
  },
  {
    ...
    explanation:
      '依據精神衛生法第 48 條與臺灣高雄地院等判決，「只要依客觀上所發生事實，有使他人可認為患者可疑為罹有精神疾病而有送醫檢查之必要，即難認通報送醫者有何違法之故意」。2019 年嘉義鐵路警察李承翰事件就是錯失通報時機的悲劇。',
  },
  {
    id: 'Q46',
    type: 'single-choice',
  ...
  },
  {
    ...
    explanation:
      '精神衛生法第 48 條關鍵字是「有傷害他人或自己，**或有傷害之虞**」— 不需要等實際發生。臺灣法院判決：「只要依客觀上所發生事實，有使他人可認為患者可疑為罹有精神疾病而有送醫檢查之必要，即難認通報送醫者有何違法之故意」。家屬陳述威脅與拒絕就醫都是「客觀事實」。',
  },
  {
    id: 'Q50',
    type: 'single-choice',
  ...
  },
  {
    ...
    category: 'both',
    module: 'M06',
    stem: '依 5/26「門診暴力事件應變作業流程」，當情緒升高需啟動求助機制時，「啟動通報機制」的正確順序為何？',
    options: [
      { id: 'A', text: '先撥 110 報警 → 通知護理長 → 啟動電腦通報 → 按緊急壓扣', isCorrect: false },
      { id: 'B', text: '啟動電腦暴力事件通報系統 → 按下緊急壓扣 → 電話通知駐警／保全（說明地點、人數、行為、是否持武器、是否有人員受困）→ 必要時報警', isCorrect: true },
      { id: 'C', text: '按緊急壓扣 → 自行與病人理論 → 等主管到場再決定通報 → 報警', isCorrect: false },
      { id: 'D', text: '先拍照錄影蒐證 → 請家屬帶離 → 再視情況通報', isCorrect: false },
    ],
    explanation:
      '依最終 SOP「三、啟動求助機制（叫團隊）」，啟動通報機制順序為：① 啟動電腦暴力事件通報系統 → ② 按下緊急壓扣 → ③ 電話通知駐警或保全人員（須說明地點、人數、行為、是否持武器及是否有人員受困）→ ④ 必要時報警處理；並同步通知支援同仁、單位主管及門診部行政人員。報警（110）是「必要時」的最後一環而非第一步；自行理論、等主管才通報、先蒐證都會延誤求助時機。',
  },
]
